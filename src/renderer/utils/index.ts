...
export default class Tool {
    ...
    static Clock = (function() {
        ...
        // private variables
        var canvas:HTMLCanvasElement, // canvas element
            ctx:any, // canvas context
            bgGrad = true, // background gradient flag
            gradient:any, // gradient (background)
            height = 180, // canvas height
            key = {
                up: false,
                shift: false
            }, // key presses
            particles:any = [], // particle array
        ...
        var pad = function(number:any) {
            return ('0' + number).substr(-2);
        };

        var particleText = function(imgData:any) {
        ...
        var setGradient = function(gradientStops:any) {
        ...
        var setStyles = function(hue:any) {
            // color stops
            var gradientStops = {
                0: 'hsl(' + hue + ', 100%, 100%)',
                0.5: 'hsl(' + hue + ', 10%, 50%)'
...
var FPS = {
    ...
    initialize: function(canvasID:any, fpsID:any) {
    ...
    createFPS: function(canvasID:any, fpsID:any) {
